...
from neko_sdk.ocr_modules.charset.etc_cset import latin62, symbol
...
trunseen = set(a["chars"]).difference(symbol).difference(t1_3755.union(cpx3755)).difference(hira).difference(
    kata).difference(latin62);
