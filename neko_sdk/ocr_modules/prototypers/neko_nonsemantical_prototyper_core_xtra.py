...
import random
from neko_sdk.ocr_modules.neko_interprinter import neko_visual_only_interprinter, neko_visual_only_interprinterHD, \
    neko_visual_only_interprinter_inv, neko_visual_only_interprinterR34
...
class neko_nonsematical_prototype_core_basic(neko_prototype_core_basic):
    ...
    def __init__(this,
        ...
        this.norm_protos = None
        this.label_set = None
        this.drop = None
        this.sp_tokens = None
        this.sp_cnt = None
        this.shaped_ids = None
        this.label_dict = None
        this.character = None
        this.shaped_characters = None
        this.aligned_characters = None
        this.output_channel = None
        this.dev_ind = None
...
class neko_nonsematical_prototype_core_castle(neko_nonsematical_prototype_core_basic):
    def make_proto_engine(this, meta, backbone, preload_tensor=None):
        ...
        this.castle = torch.nn.Parameter(
            torch.rand(len(meta["chars"]) + len(meta["sp_tokens"]), this.output_channel) * 2 - 1)
